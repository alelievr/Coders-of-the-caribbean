...
class GameReferee {
    ...
    public static int COOLDOWN_CANNON = 2;
    public static int COOLDOWN_MINE = 5;
    public static int INITIAL_SHIP_HEALTH = 100;
    public static int MAX_SHIP_HEALTH = 100;
    public static int MAX_SHIP_SPEED;
    public static int MIN_SHIPS = 1;
    public static int MAX_SHIPS;
    public static int MIN_MINES;
    public static int MAX_MINES;
    public static int MIN_RUM_BARRELS = 10;
    public static int MAX_RUM_BARRELS = 26;
    public static int MIN_RUM_BARREL_VALUE = 10;
    public static int MAX_RUM_BARREL_VALUE = 20;
    public static int REWARD_RUM_BARREL_VALUE = 30;
    public static int MINE_VISIBILITY_RANGE = 5;
    public static int FIRE_DISTANCE_MAX = 10;
    public static int LOW_DAMAGE = 25;
    public static int HIGH_DAMAGE = 50;
